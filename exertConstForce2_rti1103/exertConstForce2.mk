...
#
#  $RCSfile: exertConstForce2.mk $ $Revision: 2.39 $ $Date: 2009/11/23 16:13:00CET $
...
COMPUTER                       = PCWIN
MODEL                          = exertConstForce2
MODULES                        = exertConstForce2_data.c exertConstForce2_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
RTWCUST_INCLUDES = \
	$(START_DIR)\exertConstForce2_rti1103 \
	$(START_DIR) \
