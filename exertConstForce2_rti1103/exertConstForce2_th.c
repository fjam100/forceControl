/************************ dSPACE target specific file *************************
   ...
   Include file .\exertconstforce2_rti1103\exertConstForce2_th.c :

   Task Configuration file for model : exertConstForce2

   RTI1103 6.5 (10-May-2010)/2.2
   09-Oct-2016 18:43:40
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\exertconstforce2_rti1103\exertConstForce2_th.c is for ST).
# endif
