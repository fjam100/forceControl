/*********************** dSPACE target specific file *************************
   ...
   Include file exertConstForce2_rti.c:
...
#define RTB_STRUCTURE_NAME             exertConstForce2_B
#define RTP_STRUCTURE_NAME             exertConstForce2_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  /* dSPACE I/O Board DS1103 #1 Unit:MultiAdc */
  {
    ...
    exertConstForce2_B.SFunction_d = pvalues[8];
    exertConstForce2_B.SFunction_eb = pvalues[4];
    exertConstForce2_B.SFunction_jn = pvalues[19];
    exertConstForce2_B.SFunction_j = pvalues[18];
    exertConstForce2_B.SFunction_e = pvalues[17];
    exertConstForce2_B.SFunction = pvalues[16];
  }

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:POS */
  exertConstForce2_B.SFunction1 = (real_T) ds1103_inc_position_read(3,
