/************************ dSPACE target specific file *************************
   ...
   Include file .\exertconstforce_rti1103\exertConstForce_th.c :

   Task Configuration file for model : exertConstForce

   RTI1103 6.5 (10-May-2010)/2.2
   20-Sep-2016 16:57:35
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\exertconstforce_rti1103\exertConstForce_th.c is for ST).
# endif
