/*********************** dSPACE target specific file *************************
   ...
   Include file exertConstForce_rti.c:
...
#define RTB_STRUCTURE_NAME             exertConstForce_B
#define RTP_STRUCTURE_NAME             exertConstForce_P
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  {
    Float64 pvalues[20];
    ds1103_adc_multi_conv_read(DS1103_ADC_CHANNEL9|DS1103_ADC_CHANNEL20|
      DS1103_ADC_CHANNEL19|DS1103_ADC_CHANNEL18|DS1103_ADC_CHANNEL17|
      DS1103_ADC_CHANNEL5, pvalues);
    exertConstForce_B.SFunction_j = pvalues[8];
    exertConstForce_B.SFunction_k = pvalues[19];
    exertConstForce_B.SFunction_e = pvalues[18];
    exertConstForce_B.SFunction_f = pvalues[17];
    exertConstForce_B.SFunction_i = pvalues[16];
    exertConstForce_B.SFunction = pvalues[4];
  }

  /* dSPACE I/O Board DS1103 #1 Unit:ENC_POS Group:POS */
  exertConstForce_B.SFunction1 = (real_T) ds1103_inc_position_read(3,
