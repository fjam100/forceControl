...
#
#  $RCSfile: exertConstForce.mk $ $Revision: 2.39 $ $Date: 2009/11/23 16:13:00CET $
...
COMPUTER                       = PCWIN
MODEL                          = exertConstForce
MODULES                        = exertConstForce_data.c exertConstForce_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = exertConstForcelib.lib
...
RTWCUST_INCLUDES = \
	$(START_DIR)\exertConstForce_rti1103 \
	$(START_DIR) \
